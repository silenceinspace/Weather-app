...
function formatDates() {
  ...
  nonFormattedArray.forEach((element) => {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dateObject, 'MMMM d, y');
